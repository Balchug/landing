...
const tariffs = [
  {
    ...
    content: ['--- --- руб. в месяц', '- --- --- руб. за 12 месяцев'],
  },
  {
    title: 'БАЛЧУГ: Торговый портал (от 10 пользователей)',
    content: [
      '--- --- руб. + -- --- руб. (за каждого дополнительного пользователя) в месяц',
      '- --- --- руб. + -- --- руб. (за каждого дополнительного пользователя) за 12 месяцев',
    ],
  },
]
