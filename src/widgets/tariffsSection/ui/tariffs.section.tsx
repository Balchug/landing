...
const tariffs = [
  {
    ...
    content: ['200 000 руб. в месяц', '2 400 000руб. за 12 месяцев'],
  },
  {
    title: 'БАЛЧУГ: Торговый портал (от 5 пользователей)',
    content: [
      '200 000 руб. + 10 000руб. (за каждого дополнительного пользователя) в месяц',
      '1 400 000руб. + 10 000руб. (за каждого дополнительного пользователя) за 12 месяцев',
    ],
  },
]
